...
import sing.camera.library.util.AngleUtil;
import sing.camera.library.util.CameraParamUtil;
import sing.camera.library.util.CheckPermission;
import sing.camera.library.util.DeviceUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    //视频质量
    private int mediaQuality = SCameraView.MEDIA_QUALITY_MIDDLE;
